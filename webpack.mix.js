...
mix.js('resources/assets/backend/js/app.js', 'public/js')
    ...
    .js([
        'resources/assets/backend/js/owl.carousel.min.js',
    ], 'public/js/owl.carousel.min.js')
    .js([
        'resources/assets/backend/js/curriculum-calendar.js',
    ], 'public/js/curriculum-calendar.js')
   .js([
    ...
    .styles('resources/assets/backend/css/owl.carousel.min.css', 'public/css/owl.carousel.min.css')
    .styles('resources/assets/backend/css/owl.theme.default.css', 'public/css/owl.theme.default.css')
    .autoload({
